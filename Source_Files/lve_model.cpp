...
LveModel::LveModel(LveDevice& device, std::string objPath, std::vector<std::string> filePath, std::shared_ptr<LveDescriptorSet> descSet) : lveDevice{ device }, descriptorSet{ descSet } {
